...
const formSchema = z.object({
	...
	seed: z.string().min(200, {
		message: "Example Conversation require at least 200 characters",
	}),
...
export const CompanionForm = ({ initialData, categories }: CompanionFormProps) => {
	...
	const form = useForm<z.infer<typeof formSchema>>({
		...
		defaultValues: initialData || {
			...
			seed: "",
			src: "",
			categoryId: undefined, // cause this is a selector
		},
	});
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input
											disabled={isLoading}
											placeholder="CEO & founder of spaceX, X"
											{...field}
										/>
									</FormControl>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormDescription>
									Describe in details your companion backstory and relevant information.
								</FormDescription>
								<FormMessage />
							</FormItem>
						)}
